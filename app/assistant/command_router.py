...
def route_command(text:str)->str:
    ...
    if any(x in lower for x in ("walk-forward","walk forward","false-discovery","false discovery","overfit","robustness testing")) and any(x in lower for x in ("why","explain","show","which")): return "research_explain"
    if "draft" in lower and "experiment" in lower:return "research_experiment_draft"
    if "draft" in lower and any(x in lower for x in ("promote","reject","research decision")):return "research_decision_draft"
