...
READ_ONLY_TOOLS={"get_app_state","get_user_trading_profile","get_dashboard_layouts","get_strategy_library","get_strategy_details","get_combo_library","get_combo_details","get_strategy_validation","get_combo_validation","get_latest_signals","get_backtest_runs","get_backtest_summary","get_backtest_trades","get_paper_account","get_paper_positions","get_paper_orders","get_trade_history","get_trade_journal","get_risk_events","get_system_logs","get_watchlists","get_saved_screeners","search_app","search_docs","search_strategies","search_trades","search_backtests"}
DRAFT_TOOLS={"draft_strategy_change","draft_combo_change","draft_strategy_enable_disable","draft_screener_config","draft_watchlist_update","draft_backtest_request","draft_dashboard_layout","draft_dashboard_widget","draft_profile_update","draft_trade_journal_note","draft_paper_order","draft_risk_setting_change"}
APPROVAL_TOOLS={"apply_strategy_change","apply_combo_change","toggle_strategy","toggle_combo","save_screener","update_watchlist","run_backtest","save_dashboard_layout","add_dashboard_widget","remove_dashboard_widget","update_profile","add_trade_journal_note","place_paper_order","cancel_paper_order","update_risk_setting","reset_paper_account"}
