...
class ReadOnlyTools:
    def __init__(self,database,profile,dashboards,search,rag,strategy_library=None,combo_library=None,backtests=None,paper=None,trade_history=None,state_provider=None,paper_operations=None,paper_analytics=None):
